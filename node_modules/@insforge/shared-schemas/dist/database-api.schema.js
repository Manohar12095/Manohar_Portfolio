import { z } from 'zod';
import { columnSchema, foreignKeySchema, tableSchema, databaseFunctionSchema, databaseIndexSchema, databasePolicySchema, databaseTriggerSchema, migrationSchema, } from './database.schema.js';
...
export const createMigrationRequestSchema = z.object({
    version: z
        .string()
        .regex(/^\d{1,64}$/, 'Migration version must be a numeric string of at most 64 digits (e.g. 0001 or 20260418091500).'),
    name: z
        .string()
        .trim()
